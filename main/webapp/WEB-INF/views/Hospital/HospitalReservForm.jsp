			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>병원 예약 등록</h3>
						<form:form class="row login_form" id="contactForm" modelAttribute="reservation" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<form:input path="hospitalName" class="form-control" value="${hospital.yadmNm}" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="reserverId" type="text" class="form-control" id="reserverId" name="reserverId" placeholder="아이디" value="${memberId}" onfocus="this.placeholder = ''" onblur="this.placeholder = '아이디'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input type="datetime-local" path="reservationDate" class="form-control" id="reservationDate" name="reservationDate"  />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="reserverName" type="text" class="form-control" id="reserverName" name="reserverName" value="${userName}" placeholder="예약자 이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '예약자 이름'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="reserverPhone" type="text" class="form-control" id="reserverPhone" name="reserverPhone" placeholder="전화번호" onfocus="this.placeholder = ''" onblur="this.placeholder = '전화번호'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="patientName" type="text" class="form-control" id="patientName" name="patientName" placeholder="부상자이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '부상자이름'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="patientAge" type="text" class="form-control" id="patientAge" name="patientAge" placeholder="부상자나이" onfocus="this.placeholder = ''" onblur="this.placeholder = '부상자나이'" />
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<form:input path="injuryType" type="text" class="form-control" id="injuryType" name="injuryType" placeholder="부상수위" onfocus="this.placeholder = ''" onblur="this.placeholder = '부상부위'" />
							</div>
							<div class="col-md-12 form-group">
								<form:textarea path="notes" class="form-control" cols="50" rows="2" id="notes" name="notes" placeholder="비고/요청사항" onfocus="this.placeholder = ''" onblur="this.placeholder = '비고/요청사항'" />
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="button button-login w-100">예약하기</button>
