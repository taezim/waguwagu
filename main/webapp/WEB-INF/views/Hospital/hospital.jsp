					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto mr-auto">
							...
							<li class="nav-item submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link"
										href="/waguwagu/Lesson/lessons">클래스?</a></li>
									<li class="nav-item"><a class="nav-link"
					...
					<div class="col-lg-12">
						...
						<div class="row">
							...
							<div class="col-lg-12 mt-4">
								...
								<p>
									평일 : 08:00 ~ 17:00 <br> 토요일 : 08:00 ~ 13:00
								</p>
							</div>
						</div>
					</div>
								...
								<div class="review_box">
									...
									<div id="editFormWrapper" style="display: none;">
										<form:form id="editForm"
											action="/waguwagu/hospital/review/add" method="post"
											class="form-contact form-review mt-3"
											modelAttribute="addReview">
											<div class="form-group">
												<input path="name" id="editName" class="form-control"
													name="name" type="text" placeholder="이름을 입력하세요."
													value="${review.name}">
											</div>
											<div class="form-group">
												<input type="text" id="edithospitalid" path="hospitalId"
													class="form-control" name="hospitalId"
													value="${review.hospitalId}">
											</div>
											<div class="form-group">
												<input type="date" path="reviewDate" id="eidtdate"
													class="form-control" name="reviewDate"
													value="${review.reviewDate}">
											</div>
											<div class="form-group">
												<input type="text" id="editscore" path="reviewRating"
													class="form-control" name="reviewRating"
													placeholder="평점을 입력하세요." value="${review.reviewRating}">
											</div>
											<div class="form-group">
												<input path="userId" id="editemail" class="form-control"
													name="userId" type="email" value="${review.userId}"
													placeholder="이메일을 입력하세요." required>
											</div>
											<div class="form-group">
												<input path="title" id="edittitle" class="form-control"
													name="title" type="text" placeholder="제목을 입력하세요."
													value="${review.title}">
											</div>
											<div class="form-group">
												<textarea path="reviewContent" id="editContent"
													class="form-control different-control w-100"
													name="reviewContent" id="textarea" cols="30" rows="5"
													placeholder="글을 작성하세요." value="${review.reviewContent}"></textarea>
											</div>
											<div class="form-group text-center text-md-right mt-3">
												<button type="submit"
													class="button button--active button-review">수정하기</button>
													
											</div>
										</form:form>
									</div>
									<form:form id="realForm" action="/waguwagu/hospital/review/add"
										...
										<div class="form-group">
											<input type="text" path="hospitalId" class="form-control"
												name="hospitalId" value="${hospitalId}">
										</div>
										<div class="form-group">
											<input type="date" path="reviewDate" class="form-control"
												name="reviewDate">
										</div>
										<div class="form-group">
											<input type="text" path="reviewRating" class="form-control"
												name="reviewRating" placeholder="평점을 입력하세요.">
										</div>
										<div class="form-group">
