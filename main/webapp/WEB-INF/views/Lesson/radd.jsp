	...
	<!-- ================ end banner area ================= -->
		...
		<nav class="bread_c" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
			<ol class="breadcrumb breadhospital">
			  <li class="breadcrumb-item"><a href='<c:url value="/games"/>'>클래스목록</a></li>
			  <li class="breadcrumb-item active" aria-current="page">클래스등록</li>
			</ol>
		</nav>
	</div>	
	  <!--================Login Box Area =================-->
					...
					<div class="login_form_inner">
						...
						<form:form class="row login_form" id="contactForm" modelAttribute="addLesson" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<form:input path="coachId" class="form-control" id="coachId" name="coachId" placeholder="코치아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '코치아이디'" value="${match.teamId}" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="teamName" type="text" class="form-control" id="name" name="name" placeholder="클래스이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '클래스이름'" value="${match.teamName}"/>
							</div>
							...
							<div class="col-md-12 form-group">
								<form:input path="auditors" type="text" class="form-control" id="auditors" name="auditors" placeholder="청강 가능 인원" onfocus="this.placeholder = ''" onblur="this.placeholder = '청강 가능 인원'" value="${match.userNumber}"/>
							</div>
							<div class="col-md-12 form-group">
								<form:input path="gameImage" type="file" class="form-control" id="name" name="name" placeholder="수강료" onfocus="this.placeholder = ''" onblur="this.placeholder = '수강료'" />
							</div>
							<div class="col-md-12 form-group">
