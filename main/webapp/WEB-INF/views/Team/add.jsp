			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>팀 등록</h3>
						<form:form class="row login_form" id="contactForm" modelAttribute="addTeam" enctype="multipart/form-data">
							<div class="col-md-12 form-group">
								<form:input path="teamId" class="form-control" id="name" name="name" placeholder="구단아이디" onfocus="this.placeholder = ''" onblur="this.placeholder = '팀아이디'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="teamName" type="text" class="form-control" id="name" name="name" placeholder="팀명" onfocus="this.placeholder = ''" onblur="this.placeholder = '팀명'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="memberNumber" type="number" class="form-control" id="name" name="name" placeholder="인원수" onfocus="this.placeholder = ''" onblur="this.placeholder = '인원수'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="phoneNumber" type="text" class="form-control" id="name" name="name" placeholder="대표자번호" onfocus="this.placeholder = ''" onblur="this.placeholder = '대표자번호'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="leaderName" type="text" class="form-control" id="name" name="name" placeholder="대표자이름" onfocus="this.placeholder = ''" onblur="this.placeholder = '대표자이름'" />
							</div>
							<div class="col-md-12 form-group">
							    선호지역
							...
							<div class="col-md-12 form-group">
								<form:textarea path="description" rows="4" cols="50" class="form-control" id="name" name="name" placeholder="설명" onfocus="this.placeholder = ''" onblur="this.placeholder = '설명'" />
							</div>
							<div class="col-md-12 form-group">
								<form:input path="teamImage" type="file" class="form-control" id="name" name="name" placeholder="구단사진" onfocus="this.placeholder = ''" onblur="this.placeholder = '구단사진'" />
							</div>
<!-- 							<div class="col-md-12 form-group">
								<div class="creat_account">
