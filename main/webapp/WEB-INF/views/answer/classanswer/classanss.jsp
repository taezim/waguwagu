      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="index.html">
	          <img src="<c:url value='/resources/images/baseball.png'/>" alt=''/>
	      </a>
				...
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="<c:url value='/resources/images/category/야간연습.jpg" alt="'/>"/>
						</div>
                        <div class="single-prd-item">
                            <img class="img-fluid" src="<c:url value='/resources/images/category/야간연습.jpg" alt="'/>"/>
                        </div>
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                                <div class="col-6">
                                        <img class="img-fluid" src="<c:url value='/resources/images/category/usman-yousaf-pTrhfmj2jDA-unsplash.jpg" alt="'/>"/>
                                </div>
                                <div class="col-6">
                                        <img class="img-fluid" src="<c:url value='/resources/images/category/새우아님.jpg" alt="'/>"/>
                                </div>
					     ...
					     <form:form modelAttribute="classplus" method="post" action="/waguwagu-yeong/classquestion/add" id="contactForm" novalidate="novalidate">
					          <div class="col-md-12">
					              <div class="form-group">
					                  <form:input type="email" path="questionnumber" class="form-control" id="email" name="email" placeholder="이메일을 입력하세요."/>
					              </div>
					          </div>
					          <div class="col-md-12">
					              <div class="form-group">
					                  <form:input type="text" path="respondentid" class="form-control" id="classid" name="classid" placeholder="id를 입력하세요"/>
					              </div>
					          </div>
					          <div class="col-md-12">
					              <div class="form-group">
