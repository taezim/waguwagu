  ...
  <div class="wrap1">
    <p>QnA 답변 등록 게시판</p>
      ...
      <div id="wrap">
        ...
        <fieldset>
          <legend>board</legend>
          <form:form id="frm1" modelAttribute="classupdateanswer" method="post">
            <table>
              <caption></caption>
              <colgroup>
              ...
              <tbody>
                <tr>
                  ...
                  <td><form:input path="answernumber" id="iptName" value="${classupdatelist.answernumber }" /></td>
                </tr>
                <tr>
                  <th scope="row">질문 번호</th>
                  <td><form:input path="questionnumber" id="iptTitle" value="${classupdatelist.questionnumber }" /></td>
                </tr>
                <tr>
                  <th scope="row">내용</th>
                  <td><form:input path="answercontent" id="iptCont" cols="20" rows="5" value="${classupdatelist.answercontent}" /></td>
                </tr>
                <tr>
                  <th scope="row">답변자 아이디</th>
                  <td><form:input path="respondentid" id="iptTitle" value="${classupdatelist.respondentid}" /></td>
                </tr><tr>
                  <th scope="row">답변 날짜</th>
                  <td><form:input path="replaydate" id="iptTitle" value="${classupdatelist.replaydate}" /></td>
                </tr>
              </tbody>
            </table>
