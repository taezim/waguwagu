...
<table cellspacing="0" border="1" summary="게시판의 글제목 리스트" class="tbl_type">
    ...
    <td class="title"><a href="./hospitalanswers/hospitalanswer?an=${answer123.hospitalid}">${answer123.answercontent}</a></td>
    ...
    <br>
    <div class="divbox">
    <a href="<c:url value="/hospitalanswers/hospitaladd" />" class="btn btn-outline-secondary">글쓰기</a>
    <!-- //UI Object -->
   	</div>
</body>
</html>