  ...
  <div class="wrap1">
    <p>QnA 답변 등록 게시판</p>
      ...
      <div id="wrap">
        ...
        <fieldset>
          <legend>board</legend>
          <form:form id="frm1" modelAttribute="productupdateanswer" method="post">
            <table>
              <caption></caption>
              <colgroup>
              ...
              <tbody>
                <tr>
                  ...
                  <td><form:input path="answernumber" id="iptName" value="${productUpdateList.answernumber }" /></td>
                </tr>
                <tr>
                  <th scope="row">질문 번호</th>
                  <td><form:input path="questionnumber" id="iptTitle" value="${productUpdateList.questionnumber }" /></td>
                </tr>
                <tr>
                  <th scope="row">내용</th>
                  <td><form:input path="answercontent" id="iptCont" cols="20" rows="5" value="${productUpdateList.answercontent}" /></td>
                </tr>
                <tr>
                  <th scope="row">답변자 아이디</th>
                  <td><form:input path="respondentid" id="iptTitle" value="${productUpdateList.respondentid}" /></td>
                </tr><tr>
                  <th scope="row">답변 날짜</th>
                  <td><form:input path="replaydate" id="iptTitle" value="${productUpdateList.replaydate}" /></td>
                </tr>
              </tbody>
            </table>
