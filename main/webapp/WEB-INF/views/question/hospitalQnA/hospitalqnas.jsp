				...
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="resources/images/category/hospital3.jpg" alt="">
						</div>
                        <div class="single-prd-item">
                            <img class="img-fluid" src="resources/images/category/hospital2.jpg" alt="">
                        </div>
						<!-- <div class="single-prd-item">
	...
	<section class="product_description_area">
		<div class="container">
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="col-lg-12">
                        <div class="feature-img">
                                <img class="img-fluid" src="resources/images/category/정형외과.jpg" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                                <div class="col-6">
                                        <img class="img-fluid" src="resources/images/category/usman-yousaf-pTrhfmj2jDA-unsplash.jpg" alt="">
                                </div>
                                <div class="col-6">
                                        <img class="img-fluid" src="resources/images/category/새우아님.jpg" alt="">
                                </div>
				...
				<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
			        ...
			        <div class="col-lg-6">
							<div class="review_box">
								<h4>QnA 작성</h4>
							  <form:form modelAttribute="hospitalplus" method="post" action="/waguwagu-yeong/hospitalquestion/add" id="contactForm" novalidate="novalidate">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" id="hospitalid" name="hospitalid" placeholder="아이디를 입력해주세요."/>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
          ...
          <div id="editFormWrapper" style="display:none;">
                <form:form modelAttribute="hospitalupdateqna" method="post" action="/waguwagu-yeong/hospitalquestion/hospitalupdate" id="editForm" novalidate="novalidate">
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="text" class="form-control" id="editName" readonly="true" name="name" value="${hospital123.name}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="text" class="form-control" id="editEmail" readonly="true" name="email" placeholder="이메일을 입력하세요." value="${hospital123.email}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="text" class="form-control" id="edithospitalid" readonly="true" name="hospitalid" placeholder="id를 입력하세요" value="${hospital123.hospitalid}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <textarea class="form-control" name="content" id="editContent" rows="1" placeholder="글을 작성하세요.">${hospital123.content}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12 text-right">
...
var list = document.getElementById('comment_list').getElementsByClassName('review_item');
  ...
  function deleteConfirm(hospitalid) {
	    ...
	    {
	        // 직접 URL을 생성하여 이동합니다.
	        location.href = "/waguwagu-yeong/hospitalquestion/hospitaldelete?hospitalid=" + hospitalid;
	    } 
	    else 
	    {
	        return;
...
$(document).ready(function() {
    $('.edit_button').click(function() {
        ...
        $.ajax({
            url: '/waguwagu-yeong/hospitalquestion/hospitalupdate',
            type: 'GET',
