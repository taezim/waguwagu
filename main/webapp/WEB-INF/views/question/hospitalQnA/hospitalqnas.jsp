				...
				<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
			        ...
			        <div class="col-lg-6">
							<div class="review_box">
								<h4>QnA 작성</h4>
							  <form:form modelAttribute="hospitalplus" method="post" action="/waguwagu/hospitalquestion/add" id="contactForm" novalidate="novalidate">
				                <div class="col-md-12">
				          ...
				          <div id="editFormWrapper" style="display:none;">
				                <form:form modelAttribute="hospitalupdateqna" method="post" action="/waguwagu/hospitalquestion/hospitalupdate" id="editForm" novalidate="novalidate">
				                    <div class="col-md-12">
				                        <div class="form-group">
